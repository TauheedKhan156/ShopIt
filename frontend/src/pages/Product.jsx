      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex flex-col gap-4 my-8'>
            ...
            className='bg-black text-white px-8 py-3 me-96 text-sm rounded-md active:bg-gray-700'>
            ADD TO CART
            </button>
            <hr className='mt-8 h-[1px] bg-gray-400 border-none sm:w-4/5' />
        ...
        {/* ----------Description and Review Analysis---------- */}
        <div className='mt-20'>
          <div className='flex'>
